node{
    stage('Git Checkout'){
      git 'https://github.com/ikramshahbaz/DevopsBootCamp-01.git'
    }
    stage('mvn clean'){
        sh 'mvn clean'
    }
